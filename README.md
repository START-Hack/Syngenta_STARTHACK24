...
Onboarding process: 
1. Your team will be allocated a specific group number. Please, nominate a person from your team to come to our booth at the beginning of the Hack in order to get the group number for your team. You will also reveive at that time a specific API token to access the CEHub API.
